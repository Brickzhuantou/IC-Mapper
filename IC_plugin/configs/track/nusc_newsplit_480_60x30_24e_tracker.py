...
model = dict(
    ...
    head_cfg=dict(
        ...
        transformer=dict(
            ...
            decoder=dict(
                type='MapTransformerDecoder_new_Tracker',
                num_layers=6,
                prop_add_stage=1,
...
# load_from = '/home/jz0424/brick/mmdet3d_1.0.0rc4_base/work_dir/tracker_baseline/iter_9280.pth'
